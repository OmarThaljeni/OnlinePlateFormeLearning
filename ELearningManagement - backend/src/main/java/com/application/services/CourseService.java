...
public class CourseService
{
  ...
  {
    return courseRepo.findByCourseid(coursename);
  }

	public Course fetchCourseByCoursenameId(String coursename)
	{
  ...
  @Transactional
  public void removeCourseById(String idCourse) {
    Optional<Course> optionalEntity = courseRepo.findCourseByCourseid(idCourse);
    optionalEntity.ifPresent(entity -> courseRepo.deleteCourseByCourseid(idCourse));
  }
